                ...
                <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex items-stretch mb-3">
                        ...
                        <div class="flex flex-col w-3/4">
                            <input id="email" type="email" class="flex-grow h-8 px-2 border rounded-sm {{ $errors->has('email') ? 'border-red-dark' : 'border-grey-light' }}" name="email" value="{{ old('email') }}" required autofocus>
                    ...
                    <div class="flex items-stretch mb-4">
                        ...
                        <div class="flex flex-col w-3/4">
                            <input id="password" type="password" class="flex-grow h-8 px-2 rounded-sm border {{ $errors->has('password') ? 'border-red-dark' : 'border-grey-light' }}" name="password" required>
