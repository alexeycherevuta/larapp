...
<div class="flex items-center">
    <div class="md:w-1/2 md:mx-auto">
        <div class="rounded shadow">
            <div class="font-medium text-lg text-brand-lightest bg-brand p-3 rounded rounded-sm rounded-t">
                Register
            </div>
                ...
                <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="flex items-stretch mb-3">
                        ...
                        <div class="flex flex-col w-3/4">
                            <input id="email" type="text" class="flex-grow h-8 px-2 border {{ $errors->has('name') ? 'border-red-dark' : 'border-grey-light' }}" name="name" value="{{ old('name') }}" autofocus>
                    ...
                    <div class="flex items-stretch mb-3">
                        ...
                        <div class="flex flex-col w-3/4">
                            <input id="email" type="email" class="flex-grow h-8 px-2 border {{ $errors->has('email') ? 'border-red-dark' : 'border-grey-light' }}" name="email" value="{{ old('email') }}" required>
                    ...
                    <div class="flex items-stretch mb-4">
                        ...
                        <div class="flex flex-col w-3/4">
                            <input id="password" type="password" class="flex-grow h-8 px-2 border {{ $errors->has('password') ? 'border-red-dark' : 'border-grey-light' }}" name="password" required>
                    ...
                    <div class="flex items-stretch mb-4">
                        ...
                        <div class="flex flex-col w-3/4">
                            <input id="password_confirmation" type="password" class="flex-grow h-8 px-2 border {{ $errors->has('password_confirmation') ? 'border-red-dark' : 'border-grey-light' }}" name="password_confirmation" required>
                            {!! $errors->first('password_confirmation', '<span class="text-red-dark text-sm mt-2">:message</span>') !!}
                        </div>
                    </div>
                    <div class="flex">
                        <div class="w-3/4 ml-auto">
                            <button type="submit" class="bg-brand hover:bg-brand-dark text-white text-sm font-semibold py-2 px-4 rounded mr-3 uppercase">
                                Register
                            </button>
                        </div>
                    </div>
