                ...
                <div class="w-full md:w-1/3 lg:w-1/3 px-4 mb-2">
                    <div class="border border-grey-light bg-white shadow">
                        <article class="p-3 text-center">
                            ...
                            <a href="{{route('roles.edit', ['id' => $role->id])}}" class="bg-white bg-blue text-white p-1 rounded">Modifier</a>
                            <a href="{{route('roles.delete', ['id' => $role->id])}}" class="bg-white bg-red-dark text-white p-1 rounded">Supprimer</a>
                        </article>
                    </div>
                </div>
            @endforeach()
